...
import stylesCss from 'themes/general/styles.css?inline';
import { color } from '@vaadin/vaadin-lumo-styles/color.js';
import { typography } from '@vaadin/vaadin-lumo-styles/typography.js';
import htmlBackgroundCss from 'themes/general/components/html-background.css?inline';
import vaadinGridCss from 'themes/general/components/vaadin-grid.css?inline';
import vaadinListBoxCss from 'themes/general/components/vaadin-list-box.css?inline';
import vaadinTimePickerOverlayCss from 'themes/general/components/vaadin-time-picker-overlay.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_general_componentCss']) {
    registerStyles(
      'html-background',
      unsafeCSS(htmlBackgroundCss.toString())
    );
    registerStyles(
      'vaadin-grid',
    ...
    registerStyles(
      ...
      unsafeCSS(vaadinTimePickerOverlayCss.toString())
    );
    
    document['_vaadintheme_general_componentCss'] = true;
  }
