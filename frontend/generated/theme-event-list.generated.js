...
import stylesCss from 'themes/event-list/styles.css?inline';
import { color } from '@vaadin/vaadin-lumo-styles/color.js';
import { typography } from '@vaadin/vaadin-lumo-styles/typography.js';
import stylesCss from 'themes/event-list/components/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_event-list_componentCss']) {
    registerStyles(
      'styles',
      unsafeCSS(stylesCss.toString())
    );
    
    document['_vaadintheme_event-list_componentCss'] = true;
  }
